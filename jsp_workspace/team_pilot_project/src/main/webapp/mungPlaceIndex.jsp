                ...
                <div class="option">
                    <div>
                        <form onsubmit="searchPlaces(); return false;">
                            키워드 : <input type="text" value="부산 애견카페" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=63c1486007c82b2a0e837b0f9be50e9e&libraries=services"></script>
<script>
// 마커를 담을 배열
var markers = [];
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(35.150071, 129.111496), // 지도 중심좌표(부산)
        level: 3 // 지도의 확대 레벨
    };  
...
function addMarker(position, idx, title) {
  ...
  // 마커를 생성하고 지도 위에 마커를 표시하는 함수입니다
     function addMarker(position, idx, title) {
         var imageSrc = 'https://cdn.iconscout.com/icon/free/png-256/free-dog-1958619-1651762.png?f=webp&w=256', // 강아지 아이콘 URL
             imageSize = new kakao.maps.Size(36, 37),  // 마커 이미지 크기
             imgOptions =  {
                 spriteSize: new kakao.maps.Size(36, 37), // 강아지 이미지의 크기
                 spriteOrigin: new kakao.maps.Point(0, 0), // 강아지 이미지 중 사용할 영역의 좌상단 좌표
