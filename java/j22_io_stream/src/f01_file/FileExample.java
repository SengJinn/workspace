...
public class FileExample {
	public static void main(String[] args) {
		...
		System.out.println("path : " + file.getPath());
		System.out.println("========================================");
		// 매개변수가 2개 첫번재 매개변수가 공백이면 디스크 드라이브이 최상위 경로
		...
		if(file.exists()) {
			...
			System.out.println("디렉토리가 존재하지 않는다.");
		}
		...
		if(!file.exists()) {
			...
			// 경로상에 정의되어 있지만 존재하지 않는 모든 디렉토리 생성
		...
		// 삭제 하려는 파일 정보가 디렉토리일 경우
		// 디렉토리 내부에 하나라도 파일 정보가 존재하면 삭제 실패
