...
<div style=" margin-left: 21%;">
 ...
 <div class="row text-center" id="class_div">
  ...
  <%
	...
	ArrayList<String> 	intro_list	= new ArrayList<>();
  	...
  	try {
	  	...
	  	while(rs.next()) {
	  		...
	  		intro_list.		add(rs.getString("intro"));
  	...
  	pageContext.setAttribute("intro_list", intro_list);
				...
				html += "<div class='col-lg-3 col-md-6 mb-4'>";
					html += "<div class='card h-100'>";
						...
						html += "<div class='card-body'>";
							...
							html += "<p class='card-text'>" + intro_list[idx-1] + "</p>";
						html += "</div>";
