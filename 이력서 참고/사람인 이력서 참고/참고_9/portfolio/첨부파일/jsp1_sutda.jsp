...
<style>
	...
	input[id="menuicon"] + label {display:block; margin: 30px; width: 60px; heigth: 50px; position: relative; cursor: pointer;}
	...
	input[id="menuicon"]:check + label + div {left: 0px;}
	*/
	div[id="sidebar"] {
		width: 150px;
		height: 500px;
		background-image: url("/resources/img/bal.gif");
		position: fixed;
		top: 20%;
		left: 0px;
		z-index: 1;
...
<body>
	...
	<input type="button" id="ad_off" value="x"/>
	<div id="sidebar" onclick="window.open('https://heroesofthestorm.com/ko-kr/')"></div>	
...
//////////////////////////////////////////////////////////////////////////////////////
				...
				$("#ad_off").click(function () {
					var ad = document.getElementById("sidebar");
					ad.style.display = "none";
					document.getElementById("ad_off").style.display = "none";
				});
